...
#import "ActionLeftViewController.h"

@interface ActionLeftViewController ()
@property (weak, nonatomic) IBOutlet UIView *containerView;

@end

@implementation ActionLeftViewController
...
- (WSModallyAnimationController *)animationController {
    ...
    animation.position = WSAnimationStartLeft;
    return animation;
}
