...
#import "ActionTopViewController.h"

@interface ActionTopViewController ()
@property (weak, nonatomic) IBOutlet UIView *containerView;

@end

@implementation ActionTopViewController
...
- (WSModallyAnimationController *)animationController {
    ...
    animation.position = WSAnimationStartTop;
    return animation;
}
